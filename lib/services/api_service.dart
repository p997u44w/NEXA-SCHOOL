...
class ApiService {
  ...
  static const String hubUrl = 'https://api.nexa-school.ir';
  ...
  static Future<String> get baseUrl async {
    ...
    return 'https://api.nexa-school.ir';
  }
  ...
  /// «کد مدرسه» کلا رد می‌شه؛ در اون صورت خط `return 'https://api.nexa-school.ir';`
